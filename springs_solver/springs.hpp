...
public:
	...
	//static void spring_force_polynomial ( const T & , const std::vector<T> & , const std::vector<T> & , const std::vector<T> & , T & , T & , T & ) ;
	//static void spring_force_exponential( const T & , const std::vector<T> & , const std::vector<T> & , const std::vector<T> & , T & , T & , T & ) ;
	//static void spring_force_powerlaw   ( const T & , const std::vector<T> & , const std::vector<T> & , const std::vector<T> & , T & , T & , T & ) ;
	static void spring_force_polynomial ( const T & , const std::vector<T> & , T & , T & , T & ) ;
	static void spring_force_exponential( const T & , const std::vector<T> & , T & , T & , T & ) ;
	static void spring_force_powerlaw   ( const T & , const std::vector<T> & , T & , T & , T & ) ;
